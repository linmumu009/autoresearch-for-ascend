...
| ms-swift DPO LoRA/FSDP2 | Yes, Qwen3.6-27B DPO + LoRA + FSDP2 runs. | 8 NPUs; the 100-step + 10% eval confirmation took 5m56s, with 0.281 train steps/s and about 51.2 GiB HBM per NPU. A 50-step run saved a usable LoRA checkpoint. | Recommended LR is `2.0e-4`: 100-step eval_loss `2e-8`, eval margin `19.84`. Generation-side smoke is not yet positive: 16 short prompts matched base output exactly. |
